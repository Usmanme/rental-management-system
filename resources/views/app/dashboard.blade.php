                        ...
                        <div class="payment_box" id="booking-section">
                            ...
                            <div class="box_row">
                                <div class="pay_info pay_frame_info" data-section="booking,fleet">
                                    ...
                                    <span class="pay_bill get-u-data text_green active-booking" id="active-booking">0</span>
                                </div>
                                <div class="pay_info pay_frame_info" data-section="booking,fleet">
                        ...
                        <div class="link_icon">
                            <ul>
                                ...
                                {{-- <li class="pay_frame_info" data-section="customer"><i class="fa fa-user-circle-o"
                                        ...
                                        Customer</span></li> --}}
                                <form id="add-customer-form" action="{{ route('add-customer') }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="url" id="url">
                                    <li class="pay_frame_info" data-section="customer">
                                        <i class="fa fa-user-circle-o" aria-hidden="true"></i>
                                        <button type="submit" id="add-new-customer">Add Customer</button>
                                    </li>
                                </form>
...
@section('custom-js')
    ...
    $('#add-new-customer').click(function(e) {
        ...
        // Retrieve the URL from the data-url attribute of the button
        var url = $(this).data('url');

        // Set the URL value to the hidden input field in the form
        $('#url').val(url);
